//
//  MastersAppliedArtsViewController.m
//  ViewBook
//
...
#import "MastersAppliedArtsViewController.h"

@interface MastersAppliedArtsViewController ()

@end

@implementation MastersAppliedArtsViewController
...
- (void)viewDidLoad {
    ...
    NSString *pathToTextFile = [[NSBundle mainBundle] pathForResource:@"MAA" ofType:@"txt"];
