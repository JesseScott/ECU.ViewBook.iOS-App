//
//  MastersDigitalMediaViewController.m
//  ViewBook
//
...
#import "MastersDigitalMediaViewController.h"

@interface MastersDigitalMediaViewController ()

@end

@implementation MastersDigitalMediaViewController
...
- (void)viewDidLoad {
    ...
    NSString *pathToTextFile = [[NSBundle mainBundle] pathForResource:@"MDM" ofType:@"txt"];
