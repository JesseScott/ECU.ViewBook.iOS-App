//
//  CSApplicationDirectionsViewController.m
//  ViewBook
//
...
#import "CSApplicationDirectionsViewController.h"

@interface CSApplicationDirectionsViewController ()

@end

@implementation CSApplicationDirectionsViewController
...
- (void)viewDidLoad {
    ...
    // Load Text File
    NSString *pathToFile = [[NSBundle mainBundle] pathForResource:@"CSApplicationDirections" ofType:@"txt"];
