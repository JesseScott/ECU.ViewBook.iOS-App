//
//  GraduateContactECUADViewController.m
//  ViewBook
//
...
#import "GraduateContactECUADViewController.h"

@interface GraduateContactECUADViewController ()

@end

@implementation GraduateContactECUADViewController
...
- (IBAction)sendEmailBtn:(id)sender {
    if ([MFMailComposeViewController canSendMail]) {
        ...
        [mailer setSubject:@"App Inquiry - Graduate"];
        NSArray *toRecipients = [NSArray arrayWithObjects:@"masters@ecuad.ca", nil];
