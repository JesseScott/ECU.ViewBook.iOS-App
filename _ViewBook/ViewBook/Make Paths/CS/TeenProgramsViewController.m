...
#import "TeenProgramsViewController.h"

@interface TeenProgramsViewController ()

@end

@implementation TeenProgramsViewController
...
- (void)viewDidLoad {
    ...
    NSString *pathToTextFile = [[NSBundle mainBundle] pathForResource:@"CS Teens" ofType:@"txt"];
